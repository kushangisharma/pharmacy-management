 				...
 				<div class="column">
    				<div class="card">
    					<form action="UpdateInventory.jsp" method="post">
							...
							<p><input   style="  font-size: 16px;padding: 10px;text-align: center;border-radius: 8px;" type="text" name="restock" placeholder="Quantity" onkeypress="return event.charCode>= 48 && event.charCode<= 57" required></p>
