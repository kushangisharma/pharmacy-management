			...
			<div class="row">
 				<div class="column">
					...
					%>
  					...
  					<input style=" font-size: 16px;padding: 10px;text-align: center;border-radius: 8px;" type="number" name="orderquantity" onkeypress="return event.charCode>= 48 && event.charCode<= 57" placeholder="Enter Quantity" max="<%=rs.getInt("quantity") %>" required >
